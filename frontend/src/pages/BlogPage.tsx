...
const BlogPage: React.FC = () => 
{
    ...
    return (
        ...
        >
            ...
            <EmbedSEO
                title={isRetro ? "Null sects's Blog" : "bilal aniq's Blog"}
                description="Explore Bilal aniq's latest blog posts on various topics including technology, programming, personal projects, and more."
